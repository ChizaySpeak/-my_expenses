...
*(Добавьте сюда реальные скриншоты вашего приложения, чтобы показать интерфейс)*

| Подписки | Расходы | Список покупок |
|----------|---------|----------------|
| ![Подписки](https://via.placeholder.com/300x600?text=Скриншот+подписок) | ![Расходы](https://via.placeholder.com/300x600?text=Скриншот+расходов) | ![Покупки](https://via.placeholder.com/300x600?text=Скриншот+покупок) |
